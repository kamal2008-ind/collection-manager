        ...
        <div class="min-h-[70vh] flex items-center justify-center p-6">
            <div class="max-w-md rounded-2xl border bg-white p-8 text-center shadow-sm">
                ...
                <p class="mt-3 text-gray-600">
                    The owner has not made this book public, so it cannot be viewed from this link.
                </p>
                    ...
                    <div>
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <div>
                                @php
                                    ...
                                    $isSharedWithMe =
                                        auth()->check() && !$isOwner && $book->isSharedWith(auth()->user());
                                @endphp
                        ...
                        <div class="mt-6 flex flex-wrap gap-3">
                            <span class="whitespace-nowrap" title="Attached workspaces">
                                🏢 <span
                                    class="rounded bg-purple-100 px-1 py-1 text-lg text-purple-700">{{ $book->workspaces_count ?? 0 }}
                                    Workspaces </span>
                            </span>

                            <span class="whitespace-nowrap" title="Attached collections">
                                📁 <span
                                    class="rounded bg-yellow-100 px-1 py-1 text-lg text-yellow-700">{{ $book->collections_count ?? 0 }}
                                    Collections </span>
                            </span>
                        </div>
                    </div>
