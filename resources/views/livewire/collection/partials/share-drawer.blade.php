            ...
            <div>
                ...
                @if ($sharingCollection)
                    <p class="mt-1 text-sm text-gray-500">
                        {{ $sharingCollection->name }}
                    </p>
                @endif
            </div>

            <button type="button" wire:click="closeShareDrawer" class="text-2xl text-gray-500 hover:text-gray-800">
                ×
            </button>
        </div>
            ...
            <div>
                ...
                @else
                    <p class="rounded-lg border border-dashed p-4 text-gray-500">
                        This private collection is not shared with anyone yet.
                    </p>
                @endif
            </div>

            <div class="rounded-lg bg-gray-50 p-4 text-sm text-gray-500">
                Shared users can only view this collection. They cannot edit, trash,
                favorite, attach, detach, or share it further.
            </div>
        </div>

        <div class="flex justify-end gap-3 border-t px-6 py-5">
            <x-ui.button variant="secondary" wire:click="closeShareDrawer">
                Cancel
            </x-ui.button>
        </div>
    </div>
