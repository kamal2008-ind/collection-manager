...
class Index extends Component
{
    ...
    public string $addItemsType = 'movies';
    public string $removeItemsType = 'movies';
    ...
    public ?int $addItemsCollectionId = null;
    ...
    public function openAddItemsDrawer(int $collectionId): void
    {
        $collection = $this->abortIfNotOwner($collectionId);

        $this->addItemsCollectionId = $collection->id;
        $this->addItemsCollectionName = $collection->name;
        $this->addItemsType = 'movies';
        $this->drawerPerPage = 12;
    ...
    public function closeAddItemsDrawer(): void
    {
        ...
        $this->addItemsCollectionId = null;
        $this->addItemsCollectionName = null;
        $this->addItemsType = 'movies';
        $this->movieOptions = [];
        $this->addedMovieIds = [];
        $this->selectedMovieIds = [];
    ...
    public function openRemoveItemsDrawer(int $collectionId): void
    {
        ...
        $this->removeItemsCollectionId = $collection->id;
        $this->removeItemsCollectionName = $collection->name;
        $this->removeItemsType = 'movies';
        $this->drawerPerPage = 12;
    ...
    public function closeRemoveItemsDrawer(): void
    {
        ...
        $this->removeItemsCollectionId = null;
        $this->removeItemsCollectionName = null;
        $this->removeItemsType = 'movies';
